...
(defmacro r-infix [form]
  (cond (not (seq? form))
        ...
        (let [operator (second form)
              ...
              others (rest (rest form))] ;; removes the first element twice
          `(~operator
            (r-infix ~first-arg)
            (r-infix ~others)))))
...
(meditations
  ...
  ;; doesn't work because infix-better is not recursive
  ;; what you want to get is '(+ 10 (* 2 3))
